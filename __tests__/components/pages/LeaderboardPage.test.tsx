...
jest.mock('@/hooks/useGameHistory', () => ({
  useGameHistory: () => ({
    history: [
      { id: '1', score: 500, totalQuestions: 10, mode: 'quick', category: 'Science', playedAt: new Date().toISOString(), playerName: 'Alice', accuracy: 80, streak: 3, duration: 60 },
      { id: '2', score: 300, totalQuestions: 10, mode: 'custom', category: 'History', playedAt: new Date().toISOString(), playerName: 'Bob', accuracy: 60, streak: 1, duration: 90 },
    ],
    stats: { totalGames: 2 },
    isLoading: false,
  }),
...
jest.mock('@/lib/leaderboard', () => ({
  getLeaderboard: jest.fn(() => ({
    entries: [
      {
        rank: 1,
        entry: { id: '1', score: 500, totalQuestions: 10, mode: 'quick', category: 'Science', playedAt: new Date().toISOString(), playerName: 'Alice', accuracy: 80, streak: 3, duration: 60 },
        isPersonalBest: true,
      },
      {
        rank: 2,
        entry: { id: '2', score: 300, totalQuestions: 10, mode: 'custom', category: 'History', playedAt: new Date().toISOString(), playerName: 'Bob', accuracy: 60, streak: 1, duration: 90 },
