    ...
    <html lang="en" className={`${pressStart2P.variable} ${vt323.variable}`}>
      <body className="font-pixel-body bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 min-h-screen">
        <HelpProvider>
          ...
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:px-4 focus:py-2 focus:bg-cyan-600 focus:text-white focus:rounded focus:text-sm focus:font-bold focus-ring"
          >
