...
import AdvancedGameConfigurator, { AdvancedGameConfig, UploadedFile } from '../../components/AdvancedGameConfigurator'
    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center space-y-8 z-10 max-w-4xl w-full">
        ...
        {!selectedGameMode ? (
          ...
          <section className="w-full max-w-2xl">            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-white mb-2 pixel-text-shadow">
                {selectedGameMode === 'quick' ? '⚡ QUICK GAME' : 
                 selectedGameMode === 'custom' ? '🤖 CUSTOM GAME' : 
                 '📚 ADVANCED GAME'} SELECTED
              </h2>
            ...
            <div className="space-y-4">{/* Solo Play Option */}
              <button
              ...
              >
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-green-200 text-sm">Start immediately • No waiting • Practice mode</p>
                  </div>
                </div>
              </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">                <button
                ...
                >
                  <div className="text-3xl mb-3">🚪</div>
                  <h3 className="text-lg font-bold mb-2 pixel-text-shadow">JOIN ROOM</h3>                  <p className="text-indigo-200 text-sm">
          ...
          >
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-gray-800 border-2 border-cyan-600 rounded p-4">
                ...
                <p className="text-sm text-gray-300 leading-relaxed">
                  Both game modes support solo play or multiplayer with up to 8 players. 
                  Create a room to host, or join using a 6-character room code.
                </p>
              </div>
            </div>
          </div>
