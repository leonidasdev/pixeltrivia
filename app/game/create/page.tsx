      ...
      <div className="max-w-lg w-full text-center">
        ...
        <div className="bg-gray-900 border-4 border-gray-600 rounded-lg p-8 pixel-border">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            Room creation for <strong>{playerSettings.mode === 'quick' ? 'Quick Game' : 'Custom Game'}</strong> 
            {' '}is being developed. This will allow you to host multiplayer games with up to 8 players.
          </p>
