  ...
  return (
    <div className="min-h-[300px] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-gray-900 bg-opacity-95 border-4 border-red-600 rounded-lg p-6 text-center">
        ...
        <h2 className="text-2xl font-bold text-red-400 pixel-text-shadow mb-2">GAME OVER</h2>
...
export function PageErrorFallback({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 p-4">
      <div className="w-full max-w-lg bg-gray-900 bg-opacity-95 border-4 border-red-600 rounded-lg p-8 text-center">
        <div className="text-8xl mb-6 animate-bounce">🎮</div>
        <h1 className="text-3xl font-bold text-red-400 pixel-text-shadow mb-3">
          OOPS! GAME CRASHED
        </h1>
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mb-6 text-left bg-gray-800 rounded-lg p-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={reset}
            className="px-8 py-4 bg-purple-600 hover:bg-purple-500 text-white text-lg font-bold rounded-lg
                       ...
                       hover:scale-105 active:scale-95 pixel-border"
          >
            🔄 TRY AGAIN
          </button>
          <a
            href="/"
            className="px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white text-lg font-bold rounded-lg
                       ...
                       hover:scale-105 active:scale-95 pixel-border text-center"
          >
            🏠 MAIN MENU
          </a>
        </div>
