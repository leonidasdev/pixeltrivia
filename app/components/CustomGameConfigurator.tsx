    ...
    <div className="w-full max-w-2xl mx-auto bg-gray-900 bg-opacity-90 border-4 border-gray-600 rounded-lg p-6 backdrop-blur-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          {errors.knowledgeLevel && <p className="text-red-400 text-xs">{errors.knowledgeLevel}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs text-gray-400">{context.length}/1000 characters</span>
          </div>
          {errors.context && <p className="text-red-400 text-xs">{errors.context}</p>}
        </div>
